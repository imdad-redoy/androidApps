...
public class Tab1 extends Fragment {
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               try {
                   ...
                   cv.put(CalContract.CalEntry.COLUMN_NAME, message);

                   mDatabase.insert(CalContract.CalEntry.TABLE_NAME, null, cv);
                   ...
                   Toast.makeText(getContext(),"You must enter numbers",Toast.LENGTH_LONG).show();
               }
            }
        });
    ...
    private Cursor getAllItems(){
        return mDatabase.query(
                CalContract.CalEntry.TABLE_NAME,
                null,
                null,
                null,
                null,
                null,
                CalContract.CalEntry.COLUMN_TIMESTAMP + " DESC"
        );
    }
}
